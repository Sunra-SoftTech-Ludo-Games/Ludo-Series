...
public class GameManager
{
    ...
    public GameTimeCountDown gameTimeCountDown;
    ...
    public float playerTime = 15f; // player time in seconds
   ...
   // public bool playersHaveTypes = false;
    ...
    public float checkbalforplay=0;
    ...
    public bool allReadyPlayer = false;
    public int totalMovePawn;
    public int tournament_id;
    public bool finishedTimes = false;
    public string prizePoolMoney;
    public bool addBotPlayers = false;
    public int gamePlayedTotal;
    public bool EnterEvents = false;
    public bool JoinEvents = false;
    public int ranks;
