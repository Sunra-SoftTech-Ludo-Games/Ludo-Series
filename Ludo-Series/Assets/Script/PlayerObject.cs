...
public class PlayerObject
{
    ...
    public PlayerObject(string name, string id, Sprite avatar)
    {
        ...
        else
        {
            ...
            UserDataRecord record6 = new UserDataRecord();
            record6.Value = Random.Range(1, 250).ToString();
            this.data.data.Add(MyPlayerData.TotalPlayerWinsKey, record6);
